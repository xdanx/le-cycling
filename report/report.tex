...
This is a game played at some moment $\delta^{(n)}$ before race finish line which determines payoff at that point in space if players were to conclude competition.
...
\multicolumn{1}{ |c| }{break away} & 3 & 2 & 0 \\
& \multicolumn{1}{ |c| }{cooperate} & 2 & 3 & 1 \\
& \multicolumn{1}{ |c| }{fallback} & 2 & 2 & 0 \\ \cline{3-5}
\end{tabularx}
