...
In this research project, we aim to present new results and further develop previous work found in various papers. We hope these will be of great use in the sport.
\end{abstract}
...
%As you can read from the Introduction, our project is split into 2 parts that are described below:
