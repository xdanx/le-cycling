...
Tour de France, Giro d'Italia or Vuelta a Espa\~na. During those professional races it is expected that a group of riders break away from the main group and cooperate with each other in order to gain advantage from the main group ( called peleton ). Riders in such a
