...
%
\title[When to break away?]{Cycling simulation\\\textit{When} to break away?}
\author[]{Dan Demeter, Robert Kruszewski, Alexandru Paunoiu\\Cesar Proute, Julian Sutherland}
