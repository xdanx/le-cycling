...
\begin{columns}
  \begin{column}{0.5\textwidth}
    ...
    \begin{itemize}
      \visible<2->{
        \item Whether or not to break away.
      }
      \visible<3->{
        \item Whether or not to break away with a team mate.
      }
      \visible<4->{
        \item Whether or not to cooperate with a pack.
      }
    \end{itemize}
    \visible<5->{
      We implemented a simple probablistic model where the cyclists made each of these decisions with a (truncated) normally distributed probability.
    }
  \end{column}
